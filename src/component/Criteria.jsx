...
export default function Criteria() {
    return (
       ...
       className='lg:max-w-[50%] '>
        <h3 className=" leading-tight font-bold whitespace-nowrap">Judging Criteria

<br /> <span className="text-purple">Key attributes</span>
</h3>
<p className="!text-sm mt-10"> <span className='text-pink font-bold'>Innovation and Creativity:</span>  Evaluate the uniqueness and creativity of the
solution. Consider whether it addresses a real-world problem in a novel 
way or introduces innovative features.</p>
<p className="!text-sm mt-5"> <span className='text-pink font-bold'>Functionality:</span>   Assess how well the solution works. Does it perform its 
...
<p className="!text-sm mt-5"> <span className='text-pink font-bold'>Impact and Relevance:</span>  Determine the potential impact of the solution 
in the real world. Does it address a significant problem, and is it relevant 
to the target audience? Judges would assess the potential social, 
economic, or environmental benefits.</p>
<p className="!text-sm mt-5"> <span className='text-pink font-bold'>Technical Complexity:</span>  Evaluate the technical sophistication of the solution. 
Judges would consider the complexity of the code, the use of advanced 
technologies or algorithms, and the scalability of the solution.  </p>
<p className="!text-sm mt-5"> <span className='text-pink font-bold'>Adherence to Hackathon Rules:</span>  Judges will Ensure that the team adhered 
