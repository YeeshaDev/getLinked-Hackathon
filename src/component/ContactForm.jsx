...
function ContactForm({setShowSuccessModal}) {
    ...
    return (
        <div className=' relative lg:bg-formBg lg:p-10 lg:px-16 lg:shadow-formShadow rounded-lg flex flex-col lg:w-[500px]'>
          ...
          <h3 className='text-purple font-semibold text-[22px]'>Questions or need assistance?</h3> 
          <h3 className='text-purple font-semibold text-[22px]'>Let us know  about it!</h3> 
          <p className='lg:hidden block text-[1rem] mt-5 '>Email us below to any question related 
to our event</p>
          <form action="" className='flex flex-col  gap-y-7 mt-8'>
            ...
            <button type='submit' onClick={handleContactForm} className=' bg-primaryGradient w-[150px] h-12 text-white  flex items-center justify-center mx-auto -mt-1 rounded-lg'>Submit</button>
          </form>
        </div>
    )
}
