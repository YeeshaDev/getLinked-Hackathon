...
function Modal({showModal,heading,subText}) {
    return (
        <div className={` absolute top-[23%] lg:top-[40%]  left-[50%] translate-x-[-50%] translate-y-[-50%]  p-8 z-[999] ${showModal ? 'block' : 'hidden'}`}>
           ...
           <figure>
            ...
            <article className='flex flex-col items-center justify-center mx-auto'>
                ...
                <p className=' mt-5 text-center'>{subText}
 <span className='modal-text flex items-center justify-center gap-1' >step <img src={Wink} width='14px' height='14px' alt="" className=' wink-icon object-cover ' /> </span> 
