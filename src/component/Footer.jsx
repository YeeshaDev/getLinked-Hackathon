...
function Footer() {
    return (
        <footer className='bg-footerBg py-10 px-12 flex flex-col items-center justify-center'>
           ...
           <h1 className="text-white font-bold text-[20px] md:text-[36px]">get<span className="text-lilac">linked</span></h1>
...
<p className='mt-20'>Terms of use <span className='text-purple'>|</span> Privacy Policy</p>
           </article>
