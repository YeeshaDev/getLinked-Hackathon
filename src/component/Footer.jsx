    ...
    <footer className=" relative bg-footerBg py-10 px-12 flex flex-col items-center justify-center">
      ...
      <section className="flex flex-col lg:flex-row lg:items-center gap-16">
        <article className="lg:max-w-[50%]">
          ...
          <p className="mt-20">
            Terms of use <span className="text-purple">|</span> Privacy Policy
          </p>
        </article>
        <article className="flex flex-col lg:flex-row gap-10">
          <div>
            ...
            <div className="flex items-center gap-y-5 gap-x-2 mt-5">
              <h4 className="whitespace-nowrap "> Follow us on</h4>
              <>
                <span>
                  <svg
          ...
          <div className="flex flex-col gap-y-5">
            <h4 className="font-bold text-purple text-xl">Contact Us</h4>
            <div className="flex flex-col gap-y-5">
      ...
      <p className="mt-7">All rights reserved. © getlinked Ltd.</p>
    </footer>
  );
}
