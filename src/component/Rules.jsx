...
function Rules() {
   ...
   <h3 className=' font-bold'>Rules and <span className= 'text-purple'>Guidelines</span> </h3>
<p className="!text-sm mt-6">Our tech hackathon is a melting pot of visionaries, and its purpose is as
