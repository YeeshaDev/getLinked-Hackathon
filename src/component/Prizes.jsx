        ...
        viewport={{ once: true }}
         >
            ...
            <article className='lg:hidden flex flex-col justify-end '>
                <h3>Prizes and <br /> <span className='text-purple'>Rewards</span></h3>
                <p className='w-[80%] mx-auto  text-center lg:text-start'>Highlight of the prizes or rewards for winners and
for participants.
</p>
            </article>
            ...
            <article className='flex flex-col items-centerjustify-center lg:max-w-[50%] '>
                ...
                <h3>Prizes and <br /> <span className='text-purple'>Rewards</span></h3>
                <p className='w-[60%]'>Highlight of the prizes or rewards for winners and
for participants.</p>
                </div>
