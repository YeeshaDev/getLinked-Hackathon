...
export default function Terms() {
    return (
        ...
        viewport={{ once: true }}
        className='relative' id='overview'>
        ...
        < section className='flex flex-col lg:flex-row items-center justify-center lg:gap-10 mt-10'>
            <article className='lg:max-w-[50%] flex flex-col items-center '>
                ...
                <p className=' lg:w-[80%] text-center mx-auto lg:my-10'>Below are our privacy & policy, which outline a lot of goodies. 
...
<p className='mb-5'> At getlinked tech Hackathon 1.0, we value your privacy
...
<h4 className='font-bold text-xl text-purple my-5'>Licensing Policy</h4>
<h4 className='font-bold text-md mb-5'>Here are terms of our Standard License:</h4>
<span className='flex items-start gap-3 my-5'>
    <img src={GreenCheck} width='17px' height='17px'  alt=""  className='mt-1'/>
